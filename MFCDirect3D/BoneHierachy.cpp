		...
		)
{
	...
	for( DWORD i = 0 ; i < NumMaterials ; i++ )
	{
		...
		if( pMaterials[i].pTextureFilename != NULL )
		{
			...
			//만약 Texture 가 없다면...
			if( pNorTex == NULL ){
				pNorTex = RESOURCE_TEXTURE->GetResource( "../../MapToolResource/Resources/Meshes/normalDefault.png" );
			}	
			...
			//만약 Texture 가 없다면...
			if( pEmiTex == NULL ){
				pEmiTex = RESOURCE_TEXTURE->GetResource( "../../MapToolResource/Resources/Meshes/emissionDefault.png" );
			}
			...
			//만약 Texture 가 없다면...
			if( pSpcTex == NULL ){
				pSpcTex = RESOURCE_TEXTURE->GetResource( "../../MapToolResource/Resources/Meshes/specularDefault.png" );
			}
			//Texture 푸쉬
		...
		else
		{
			...
			//NULL 값이라도 대입해야 한다
			boneMesh->DiffuseTexs.push_back( RESOURCE_TEXTURE->GetResource( "../../MapToolResource/Resources/Meshes/diffuseDefault.png" ) );
			boneMesh->NormalTexs.push_back( RESOURCE_TEXTURE->GetResource( "../../MapToolResource/Resources/Meshes/normalDefault.png" ) );
			boneMesh->SpecularTexs.push_back( RESOURCE_TEXTURE->GetResource( "../../MapToolResource/Resources/Meshes/specularDefault.png" ) );
			boneMesh->EmissionTexs.push_back( RESOURCE_TEXTURE->GetResource( "../../MapToolResource/Resources/Meshes/emissionDefault.png" ) );
		}
	}
